          ...
          <div className="max-w-5xl mx-auto w-full">
            <h1 className="text-center text-[10vw] sm:text-[7vw] md:text-[5.5vw] lg:text-[4.5vw] leading-[0.95] font-black uppercase tracking-tight">
              ...
              <span className="group relative inline-flex items-center text-yellow-400 cursor-default">
                ...
                <span className="absolute left-[calc(100%-0.5rem)] top-1/2 -translate-y-1/2 w-16 h-16 md:w-20 md:h-20 bg-yellow-100 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 scale-0 group-hover:scale-100 transition-all duration-300 text-3xl md:text-4xl z-10">
                  📊
                </span>
              </span>
              ,<br />
              ...
              <span className="group relative inline-flex items-center text-cyan-400 cursor-default">
                ...
                <span className="absolute left-[calc(100%-0.5rem)] top-1/2 -translate-y-1/2 w-16 h-16 md:w-20 md:h-20 bg-cyan-100 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 scale-0 group-hover:scale-100 transition-all duration-300 text-3xl md:text-4xl z-10">
                  ⚡
                </span>
              </span>
              ,<br />
              ...
              <span className="group relative inline-flex items-center text-pink-400 cursor-default">
                ...
                <span className="absolute left-[calc(100%-0.5rem)] top-1/2 -translate-y-1/2 w-16 h-16 md:w-20 md:h-20 bg-pink-100 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 scale-0 group-hover:scale-100 transition-all duration-300 text-3xl md:text-4xl z-10">
                  🎯
                </span>
              </span>
              ,<br />
              ...
              <span className="group relative inline-flex items-center text-orange-500 cursor-default">
                ...
                <span className="absolute left-[calc(100%-0.5rem)] top-1/2 -translate-y-1/2 w-16 h-16 md:w-20 md:h-20 bg-orange-100 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 scale-0 group-hover:scale-100 transition-all duration-300 text-3xl md:text-4xl z-10">
                  💰
                </span>
              </span>
              .
            ...
            <ScrollReveal animation="fade-up" duration={1000}>
              <div>
                <h2 className="text-[10vw] sm:text-[8vw] md:text-[5vw] lg:text-[3.5vw] leading-[0.95] font-black uppercase tracking-tight">
                  ...
                  <span className="text-cyan-400">{t("services.mainTitle.part4")}</span>
                </h2>
              </div>
            </ScrollReveal>
