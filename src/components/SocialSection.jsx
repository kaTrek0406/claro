    ...
    <div className="px-6" onMouseMove={handleMouseMove}>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-16 relative">
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-tight font-black uppercase tracking-tight max-w-6xl mx-auto text-center">
        ...
        <div className="text-center">
          <h3 className="text-5xl sm:text-6xl md:text-7xl lg:text-7xl xl:text-8xl leading-[0.95] font-black uppercase tracking-tight mb-8 max-w-4xl mx-auto">
            Давайте создадим{" "}
